...
export default function Table() {
  return (
    <div>
       <Datepicker inline theme={datePickerTheme} />
       <div className=' flex justify-center align-middle m-3 mt-3 flex-col'>
        <header className=' text-green-400  text-[30px] font-heading pl-[20px]'><span className=' text-red-400'>Short </span>Preview</header>
        <h1 className=' flex  text-heading '>Check up latest news in the world of sports</h1>
        </div>
    <TableCard /> 
    <TableCard /> 
    <TableCard /> 
