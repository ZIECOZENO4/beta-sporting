...
<div className="w-full min-h-screen flex items-center justify-center">
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
            <div className="w-full md:text-4xl text-2xl  font-bold">
                <h1 className="w-full md:w-2/3">How can we help you, get
                    in touch</h1>
            </div>
            <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                <p className="w-full md:w-2/3 text-gray-400">To ensure a close and friendly relationship with Zeno Web team and Beta Sporting, and also for sponsorships and complaints, kindly  click on the contact button and we will render you the required attention and sevice immediately. You are welcomed to Beta Sporting Enjoy our features</p>
            ...
            <div className="flex flex-col">
                ...
                <p className="w-full text-center my-12 text-gray-600">Copyright © 2023 Beta Sporting</p>
            </div>
        </div>
    </div>
  </div>
