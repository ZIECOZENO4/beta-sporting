...
export default function Phonenav() {
  ...
  return (
    <Navbar className={`bg-slate-400 md:hidden flex justify-between px-2 w-[100vw] overflow-hidden`}>
      <NavbarContent className="md:hidden w-[100vw] gap-6" justify="center">
