            ...
            <div className="grid grid-cols-1 gap-8 mt-2 md:mt-2 md:grid-cols-2">
                <div className="lg:flex">
                    ...
                    <div className="flex flex-col justify-between py-6 lg:mx-6">
                        <Link href="#" className="text-xl font-semibold text-gray-400 hover:underline dark:text-white ">
                            How to use sticky note for problem solving
                        </Link>
                        
                        <span className="text-sm text-slate-400 dark:text-gray-300">On: 20 October 2019</span>
                    </div>
                </div>
