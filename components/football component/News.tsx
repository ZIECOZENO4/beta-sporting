...
import { getNewsInfo } from "../../app/api/index"
...
const News = async () => {
  ...
  return (
    <div className='w-[350px] bg-[rgb(40,46,58)]  px-2 md:px-6  py-2'>
      <h1 className='text-2xl text-teal-400 font-bold mb-6'>HEADLINES ON BETA</h1>
      <div>
        {newsData.map((news) => (
